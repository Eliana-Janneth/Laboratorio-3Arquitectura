...
/**
 * REST controller for managing {@link com.udea.domain.Profesor}.
 */
@RestController
@RequestMapping("/api")
@Transactional
        ...
        Optional<Profesor> result = profesorRepository
            ...
            .map(existingProfesor -> {
                ...
                if (profesor.getTipo() != null) {
                    existingProfesor.setTipo(profesor.getTipo());
                }
                if (profesor.getCorreoElectronico() != null) {
                    existingProfesor.setCorreoElectronico(profesor.getCorreoElectronico());
                }
                if (profesor.getUsuarioPortal() != null) {
                    existingProfesor.setUsuarioPortal(profesor.getUsuarioPortal());
                }
