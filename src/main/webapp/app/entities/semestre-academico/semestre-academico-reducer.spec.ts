...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './semestre-academico.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SEMESTREACADEMICO_LIST actions', async () => {
    ...
    it('dispatches FETCH_SEMESTREACADEMICO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SEMESTREACADEMICO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SEMESTREACADEMICO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SEMESTREACADEMICO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SEMESTREACADEMICO actions', async () => {
      const expectedActions = [
        {
