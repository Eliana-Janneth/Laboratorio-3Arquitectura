...
export const EstudianteDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="labArquiJHipsterApp.estudiante.delete.question">
        <Translate contentKey="labArquiJHipsterApp.estudiante.delete.question" interpolate={{ id: estudianteEntity.id }}>
