...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './actividad.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ACTIVIDAD_LIST actions', async () => {
    ...
    it('dispatches FETCH_ACTIVIDAD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ACTIVIDAD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ACTIVIDAD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ACTIVIDAD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ACTIVIDAD actions', async () => {
      const expectedActions = [
        {
