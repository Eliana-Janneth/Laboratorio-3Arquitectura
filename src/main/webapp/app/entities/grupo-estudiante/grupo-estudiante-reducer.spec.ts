...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_GRUPOESTUDIANTE_LIST actions', async () => {
    ...
    it('dispatches FETCH_GRUPOESTUDIANTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_GRUPOESTUDIANTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_GRUPOESTUDIANTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_GRUPOESTUDIANTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_GRUPOESTUDIANTE actions', async () => {
      const expectedActions = [
        {
