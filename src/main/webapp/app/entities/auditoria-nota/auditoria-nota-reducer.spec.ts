...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_AUDITORIANOTA_LIST actions', async () => {
    ...
    it('dispatches FETCH_AUDITORIANOTA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_AUDITORIANOTA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_AUDITORIANOTA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_AUDITORIANOTA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_AUDITORIANOTA actions', async () => {
      const expectedActions = [
        {
