...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './nota.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_NOTA_LIST actions', async () => {
    ...
    it('dispatches FETCH_NOTA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_NOTA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_NOTA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_NOTA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_NOTA actions', async () => {
      const expectedActions = [
        {
