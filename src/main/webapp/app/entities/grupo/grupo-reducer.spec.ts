...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './grupo.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_GRUPO_LIST actions', async () => {
    ...
    it('dispatches FETCH_GRUPO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_GRUPO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_GRUPO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_GRUPO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_GRUPO actions', async () => {
      const expectedActions = [
        {
